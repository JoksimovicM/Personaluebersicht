...
import test.gui.component.PersonListe;
...
public class Uebersicht extends JPanel {
     ...
     */
    public Uebersicht(JFrame besitzer) {
        ...
        try {
            lupeBild = ImageIO.read(new File("src/test/images/lens.png"));
        } catch (IOException e) {
            e.printStackTrace();
        }
        ...
        try {
            personBild = ImageIO.read(new File("src/test/images/default.jpg"));
        } catch (IOException e) {
            e.printStackTrace();
        }
        ...
        funktionPane = startseite.createList(funktionPane, "Funktion:", funktionPaneList, new Vector<>(),100, 160,1);
        ...
        teamPane = startseite.createList(teamPane, "Teams:", teamPaneList, new Vector<>(),100, 160,1);
